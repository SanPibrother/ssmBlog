						...
						<div class="main-20">
							...
							<div class="block no-shadow">
								...
								<div class="main" style="margin-bottom:200px;">
									<label zoom="1.2"><input type="radio" class="fill" name="radio" value="back" />批量恢复</label>
									<br />
									<label zoom="1.2"><input type="radio" class="fill" name="radio" value="delete" />彻底消除</label>
									<br />
